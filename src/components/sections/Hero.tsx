      ...
      <div className="relative mx-auto w-full max-w-wide gutter">
        ...
        <h1 id="hero-heading" className="group/name mt-10 grid place-items-start">
          ...
          */}
          ...
          <span
            aria-hidden
            className="font-serif text-5xl leading-[1.15] font-light tracking-tight text-balance text-fg-strong transition-[translate,opacity,filter] duration-700 ease-[var(--ease-out-quart)] [grid-area:1/1] group-hover/name:-translate-y-[0.06em] group-hover/name:opacity-0 group-hover/name:blur-[3px] md:text-7xl"
          >
            {site.hero.name}
          </span>
          ...
          <span
            aria-hidden
            lang="hi"
            className="translate-y-[0.06em] text-5xl leading-[1.15] text-fg-strong opacity-0 blur-[3px] transition-[translate,opacity,filter] duration-700 ease-[var(--ease-out-quart)] [grid-area:1/1] group-hover/name:translate-y-0 group-hover/name:opacity-100 group-hover/name:blur-[0px] md:text-7xl"
          >
